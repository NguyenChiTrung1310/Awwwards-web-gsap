    ...
    () => {
      ...
      boxes.forEach((box, index) => {
        gsap.to(box, {
          ...
          scrollTrigger: {
            trigger: box,
            start: 'bottom bottom', // Start the animation when the top of the box is at 80% of the viewport height
            end: 'top 30%', // End the animation when the top of the box is at 30% of the viewport height
